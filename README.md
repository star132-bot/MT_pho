...
- Supabase email and Google OAuth Register/Verify/Sign In/Sign Out/Forgot/Reset flow with server-side PKCE, HttpOnly session cookies, CSRF protection, owner isolation, and Admin MFA guards.
