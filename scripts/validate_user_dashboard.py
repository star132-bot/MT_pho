...
def main() -> None:
    ...
    require(html, {
        ...
        'data-dashboard-cover-upload',
        'data-dashboard-cover-file',
        'src="/archive-upload.js',
        'src="/account-menu.js',
        'src="/dashboard.js',
    }, "Dashboard page")
    require(javascript, {
        ...
        'dashboardApiMutation("/api/uploads/intents"',
        'window.MTArchiveUpload.buildUploadedItem',
        'async function uploadLocalCover(file)',
        'async function waitForCoverCandidate(imageId, signal)',
        'body: { asset_id: candidate.id }',
        'dashboardCoverFile.addEventListener("change"',
    ...
    require(styles, {
        ...
        ".dashboard-cover",
        ".dashboard-cover-source",
        ".dashboard-cover-upload",
