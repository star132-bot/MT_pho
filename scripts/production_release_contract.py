...
REQUIRED_RELEASE_FILES = PUBLIC_RUNTIME_FILES | DATABASE_MIGRATION_FILES | frozenset({
    ...
    "deploy/offsite-backup-environment.example",
    ...
    "deploy/mt-presence-offsite-backup.service",
    "deploy/mt-presence-offsite-backup.timer",
    "deploy/mt-presence-offsite-verify.service",
    "deploy/mt-presence-offsite-verify.timer",
